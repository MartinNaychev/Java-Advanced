...
public class Terrain {
    ...
    public String getTanksByBarrelCaliberMoreThan(int barrelCaliber) {
        ...
        if (!tankBuilder.isEmpty()) {
            ...
            stringBuilder.append("There are no ExamPreparation.exam2.tanks with the specified caliber.");
        }
    ...
    public String getStatistics(){
        ...
        if (tanks.isEmpty()){
            stringBuilder.append(String.format("There are no ExamPreparation.exam2.tanks in the %s.",this.type.toLowerCase()));
