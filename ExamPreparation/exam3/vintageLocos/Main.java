...
//Initialize entities (Locomotive)
        Locomotive puffingBilly = new Locomotive("Puffing Billy","Jonathan Forster",
                LocalDate.of(1814, 1, 1), 1524, 8250, 8);


        Locomotive flyingScotsman = new Locomotive("Flying Scotsman","Doncaster Works",
                LocalDate.of(1923, 2, 14), 1435, 96250, 161);


        Locomotive cityOfTruro = new Locomotive("City of Truro","GWR Swindon Works",
                LocalDate.of(1903, 4, 1), 1435, 56200, 160);
